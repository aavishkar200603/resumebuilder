          ...
          <div className="p-4 md:w-1/3">
            <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
              <div className="flex items-center mb-3">
                <div className="w-16 h-16 mr-3 inline-flex items-center justify-center  text-white flex-shrink-0">
                  <svg
                    // className="w-16 h-16"
                    viewBox="0 0 220 180"
                ...
                <div className="w-16 h-16 mr-3 inline-flex items-center justify-center  text-white flex-shrink-0">
                  ...
                  >
                    <foreignObject width="100%" height="100%">
                      <img
                        alt="Person"
                        src="https://th.bing.com/th/id/R.f40f2e155906e5d44a6fe5e99a005047?rik=XFcQ1D177Vk6dw&riu=http%3a%2f%2fmundoweb.de%2fwp-content%2fuploads%2f2018%2f02%2f1-ct-person.jpg&ehk=QtPuqV%2fgN6vZrGr394Edit8ijAHmx%2bCX50d0tUh30%2fc%3d&risl=&pid=ImgRaw&r=0"
                        style={{
                          width: "100%",
                          height: "100%",
                          // borderRadius: "50%",
