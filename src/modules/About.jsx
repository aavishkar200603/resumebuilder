...
//             <h2 className="text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl text-yellow-300">
...
//             </p>
//           </div>
//           <div className="mx-auto mt-8 flex flex-col items-center md:flex-row justify-center">
...
//                   </h2>
//                   {expandedQuestion === q.id && (
//                     <p className="mt-2 text-sm leading-6 tracking-wide text-gray-400">
//                       {q.answer}
//                     </p>
//                   )}
//                 </div>
...
//                   </h2>
//                   {expandedQuestion === q.id && (
//                     <p className="mt-2 text-sm leading-6 tracking-wide text-gray-400 overflow-auto">
//                       {q.answer}
//                     </p>
//                   )}
//                 </div>
    ...
    <section className="bg-gray-800 text-white py-16">
      <div className="mx-auto max-w-7xl px-2 md:px-0">
        <div>
          ...
          <div className="mx-auto mt-8 flex flex-col md:flex-row gap-10 justify-center ml-48">
              ...
              {questions.slice(0, 3).map((q) => (
                <div key={q.id} className="mb-6">
                  <div
                    ...
                    onClick={() => handleQuestionClick(q.id)}
                  >
                    <h2 className="text-xl font-semibold cursor-pointer hover:text-yellow-500 transition-colors duration-300">
                      {q.question}
                    </h2>
                    {expandedQuestion === q.id && (
                      <p className="mt-2 text-sm leading-6 tracking-wide text-gray-400">
            ...
            <div className="max-w-3xl md:w-1/2 mr-24">
              {questions.slice(3).map((q) => (
                <div key={q.id} className="mb-6">
                  <div
                    className="question-container"
